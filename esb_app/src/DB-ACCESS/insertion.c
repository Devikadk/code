...
#define INSERT "insert into esb_request(sender_id,dest_id,message_type,reference_id,      message_id,received_on,data_location,status,status_details) values(?,?,?,?,?,CURRENT_TIMESTAMP,?,?,?)" 
